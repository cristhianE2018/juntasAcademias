        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> Actualizar academia </h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                        <strong>Id de la academia : </strong>
                                        <input type="number" name="txtid" class="form-control" placeholder="añade nombre">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                        <button type="submit" class="btn btnagregar btn-block" id="btnAgregarNuevo"><i class="fas fa-save"></i> Actualizar </button>
                                </div>
                            </div>
                        </div>
                    </form>
